...
generate <- function(NUM, p, design, var1, var2) {
  ...
  if (design == 1){
    ...
    ya <- wa + (1 - 2 * wa) *Xa[,1] + Xa[,2] + rnorm(NUM, 0, var1)
    yb <- wb + (1 - 2 * wb) *Xb[,1] + Xb[,2] + rnorm(NUM, 0, var1)
    yc <- wc + (1 - 2 * wc) *Xc[,1] + Xc[,2] + rnorm(NUM, 0, var1)
    ya_ <- wa_ + (1 - 2 * wa_) *Xa[,1] + Xa[,2] + rnorm(NUM, 0, var1)
    yb_ <- wb_ + (1 - 2 * wb_) *Xb[,1] + Xb[,2] + rnorm(NUM, 0, var1)
    yc_ <- wc_ + (1 - 2 * wc_) *Xc[,1] + Xc[,2] + rnorm(NUM, 0, var1)
    f <- y ~ x1 + x2 + x3 + x4 + x5 + x6 + x7 + x8 + x9 + x10  
  } else if (design == 2) {
    ## y1 ~ N(1 - x1 + x2 + x3 + ... + x10, 1)
    ## y0 ~ N(x1 + x2 + x3 + ..., + x10, 1)
    ## f = y ~ x1 + x2 + x3 + x4 + x5 + x6 + x7 + x8 + x9 + x10  
    ya <- wa + (1 - 2 * wa) *Xa[,1] + Xa[,2] + rowSums(Xa[,3:p]) + rnorm(NUM, 0, var1)
    yb <- wb + (1 - 2 * wb) *Xb[,1] + Xb[,2] + rowSums(Xb[,3:p]) + rnorm(NUM, 0, var1)
    yc <- wc + (1 - 2 * wc) *Xc[,1] + Xc[,2] + rowSums(Xc[,3:p]) + rnorm(NUM, 0, var1)
    ya_ <- wa_ + (1 - 2 * wa_) *Xa[,1] + Xa[,2] + rowSums(Xa[,3:p]) + rnorm(NUM, 0, var1)
    yb_ <- wb_ + (1 - 2 * wb_) *Xb[,1] + Xb[,2] + rowSums(Xb[,3:p]) + rnorm(NUM, 0, var1)
    yc_ <- wc_ + (1 - 2 * wc_) *Xc[,1] + Xc[,2] + rowSums(Xc[,3:p]) + rnorm(NUM, 0, var1)
    f <- y ~ x1 + x2 + x3 + x4 + x5 + x6 + x7 + x8 + x9 + x10  
    ...
    ## y0 ~ N(x1 + x2, 0.1)
    ## f = y ~ x1 + x2 
    ya <- wa + (1 - 2 * wa) *Xa[,1] + Xa[,2] + rnorm(NUM, 0, var2)
    ya_ <- wa_ + (1 - 2 * wa_) *Xa[,1] + Xa[,2] + rnorm(NUM, 0, var2)
    yb <- wb + (1 - 2 * wb) *Xb[,1] + Xb[,2] + rnorm(NUM, 0, var2)
    yb_ <- wb_ + (1 - 2 * wb_) *Xb[,1] + Xb[,2] + rnorm(NUM, 0, var2)
    yc <- wc + (1 - 2 * wc) *Xc[,1] + Xc[,2] + rnorm(NUM, 0, var2)
    yc_ <- wc_ + (1 - 2 * wc_) *Xc[,1] + Xc[,2] + rnorm(NUM, 0, var2)
    f <- y ~ x1 + x2  
  }else if(design == 4){
    ## y1 ~ N(1 - x1 + x2, 0.1)
    ## y0 ~ N(x1 + x2, 0.1)
    ...
    ## y0 ~ N(x1 + x2, 0.1)
    ## f = y ~ x1 + x2 + x3 + x4 + x5 + x6 + x7 + x8 + x9 + x10  
    ya <- Xa[,1] + Xa[,2] + rnorm(NUM, 0, var2)
    yb <- Xb[,1] + Xb[,2] + rnorm(NUM, 0, var2)
    yc <- Xc[,1] + Xc[,2] + rnorm(NUM, 0, var2)
    ya_ <- Xa[,1] + Xa[,2] + rnorm(NUM, 0, var2)
    yb_ <- Xb[,1] + Xb[,2] + rnorm(NUM, 0, var2)
    yc_ <- Xc[,1] + Xc[,2] + rnorm(NUM, 0, var2)
    f <- y ~ x1 + x2 + x3 + x4 + x5 + x6 + x7 + x8 + x9 + x10
  }
